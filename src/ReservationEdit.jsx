...
const ReservationEdit = ({setMuokkaustila, setIsPositive, setMessage, setShowMessage, muokattavaReservation}) => {
...
const handleSubmit = (event) => {
    ...
    .then(response => {
      if (response.status === 200) {
        setMessage("Edited Reservation: " + newReservation.propertyName )
        setIsPositive(true)
        setShowMessage(true)
